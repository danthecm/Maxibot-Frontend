...
def dashboard():
    if request.method == "POST":
        ...
        return render_template("index.html", round=round, float=float, orders=db.get_all_trades, order=get_order, balance=get_asset_balance)
    return render_template("index.html", round=round, float=float, balance=get_asset_balance, orders=db.get_all_trades, order=get_order)
